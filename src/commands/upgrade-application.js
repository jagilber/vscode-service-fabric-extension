...
function upgradeApplication() {
    return __awaiter(this, void 0, void 0, function () {
        var version, clusterInfo;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, readVersionFromManifest()];
                case 1:
                    version = _a.sent();
                    return [4 /*yield*/, readCloudProfile()];
                case 2:
                    clusterInfo = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    uri = null;
                    return [4 /*yield*/, vscode.workspace.findFiles('**/upgrade' + installScriptExtension)];
                case 1:
                    uri = _a.sent();
                    if (uri.length < 1) {
...
function readVersionFromManifest() {
    return __awaiter(this, void 0, void 0, function () {
        var fs, cloudProfile, pathToCloudProfile, manifest, manifestJs, parseString, version;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fs = require('fs');
                    return [4 /*yield*/, vscode.workspace.findFiles('**/ApplicationManifest.xml')];
                case 1:
                    cloudProfile = _a.sent();
                    pathToCloudProfile = cloudProfile[0].fsPath.replace('/c:', '');
                    manifest = fs.readFileSync(pathToCloudProfile).toString('utf8');
                    parseString = require('xml2js').parseString;
                    parseString(manifest, function (err, result) {
                        manifestJs = result;
                    });
                    version = manifestJs['ApplicationManifest']['$']['ApplicationTypeVersion'];
...
function readCloudProfile() {
    return __awaiter(this, void 0, void 0, function () {
        var fs, cloudProfile, pathToCloudProfile, profile, clusterData, clusterInfo;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fs = require('fs');
                ...
                case 1:
                    cloudProfile = _a.sent();
                    pathToCloudProfile = cloudProfile[0].fsPath.replace('/c:', '');
                    profile = fs.readFileSync(pathToCloudProfile).toString('utf8');
                    clusterData = JSON.parse(profile);
