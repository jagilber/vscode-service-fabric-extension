...
function publishApplication() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, readCloudProfile()];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
            ...
            switch (_a.label) {
                case 0:
                    ...
                    pty = {
                        ...
                        open: function () { writeEmitter.fire('Opening Terminal'); },
                        close: function () { },
                        handleInput: function (data) { return writeEmitter.fire(data); }
                        //handleInput: data => writeEmitter.fire(data === '\r' ? '\r\n' : data)
                    };
                    terminal = vscode.window.createTerminal({ name: 'Local echo', pty: pty });
                    return [4 /*yield*/, terminal.processId];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, terminal.show()];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, pty.onDidWrite(function () { return console.log; })];
                case 3:
                    _a.sent();
...
function readCloudProfile() {
    return __awaiter(this, void 0, void 0, function () {
        var fs, cloudProfile, pathToCloudProfile;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fs = require('fs');
