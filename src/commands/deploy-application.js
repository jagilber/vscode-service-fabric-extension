...
function deployApplication() {
    return __awaiter(this, void 0, void 0, function () {
        var terminal, buildFiles;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    terminal = vscode.window.createTerminal('ServiceFabric');
                    if (!(vars._isLinux || vars._isMacintosh)) return [3 /*break*/, 1];
                    ...
                    return [3 /*break*/, 3];
                case 1:
                    if (!vars._isWindows) return [3 /*break*/, 3];
                    return [4 /*yield*/, vscode.workspace.findFiles('**/build.gradle')];
                case 2:
                    buildFiles = _a.sent();
